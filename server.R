...
reticulate::virtualenv_install('python3_env',packages = 'PyTorch') 
reticulate::virtualenv_install('python3_env',packages = 'transformers') 

reticulate::py_list_packages(envname = 'python3_env')
